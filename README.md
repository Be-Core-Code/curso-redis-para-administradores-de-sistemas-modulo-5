# Diapositivas del Curso Redis para Administradores de Sistemas - Módulo 5: Alta disponibilidad
...
```bash
> docker run --rm -p "8000:8000" becorecode/curso-redis-para-administradores-de-sistemas-modulo-5:latest
```
